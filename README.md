...
**這個 portfolio 適合：**
- **看「能不能做完整系統」的雇主** — 從真實 Yahoo Finance v8 chart API → 11 種純函式策略 → Gemma 4 31B 推論 → SSG 多市場儀表板，**端到端 pipeline 都在這個 repo 裡**
...
**`_quant-terminal` 是 GKS 從 0 到 1 自行設計實作的全球多市場 AI 量化分析儀表板** — Next.js 14 + Yahoo Finance 真資料 + Gemma 4 31B 推論 + 11 策略純函式，所有資料 pipeline 都在這個 repo 內。
...
[🌐 Live Demo](https://your-deploy.vercel.app) · [📖 English](./README.en.md) · [⚙️ DESIGN.md](./DESIGN.md)
