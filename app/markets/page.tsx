...
export const metadata: Metadata = {
  ...
  description: `每日股市儀表板可擴充涵蓋的 ${EXTENDED_TOTAL} 檔多市場標的清單。後端 daily_stock_analysis 修改 STOCK_LIST 即可加入。`,
};
        ...
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
          ...
          <header className="mt-6">
            ...
            <p className="mt-3 text-[14px] max-w-[640px]" style={{ color: "#a8a8b3" }}>
              首頁 12 檔是「重點分析」（含完整 AI 決策 + 11 策略 + sparkline）；本頁列 {EXTENDED_TOTAL} 檔擴充宇宙，後端 daily_stock_analysis 修 <code className="font-mono text-[#d0d6e0]">STOCK_LIST</code> 即可加入分析範圍。
              <br />
